...
import center from '@/views/center'
    ...
    import jiaoshiOrder from '@/views/modules/jiaoshiOrder/list'
    ...
    import dictionaryJiaoshiOrder from '@/views/modules/dictionaryJiaoshiOrder/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryJiaoshiOrder',
        name: '使用状态',
        component: dictionaryJiaoshiOrder
    }
    ,{
