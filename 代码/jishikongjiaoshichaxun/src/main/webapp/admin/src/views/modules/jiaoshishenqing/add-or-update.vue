    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="座位" prop="zuoweiNumber">
                        <el-input v-model="jiaoshiForm.zuoweiNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教室地点" prop="jiaoshiAddress">
                        <el-input v-model="jiaoshiForm.jiaoshiAddress"
                                  placeholder="教室地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="楼层" prop="loucengValue">
                        <el-input v-model="jiaoshiForm.loucengValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教室状态" prop="jiaoshiOrderValue">
                        <el-input v-model="jiaoshiForm.jiaoshiOrderValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="使用原因" prop="jiaoshiText">
                        <el-input type="textarea"  :readonly="ro.jiaoshiText" v-model="ruleForm.jiaoshiText" placeholder="使用原因"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoshiText" label="使用原因" prop="jiaoshiText">
                            <span v-html="ruleForm.jiaoshiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
